...
def test(power_level, mode, is_student=True):
    ...
    return ACUnitClass('ac', 0, 0, power_level, mode).get_temperature_change()
...
testcases = [
    ...
    {'power_level': 5, 'mode': ACUnit.MODE_HEAT},
    {'power_level': 2, 'mode': ACUnit.MODE_OFF},
    {'power_level': 0, 'mode': ACUnit.MODE_COOL},
    {'power_level': 1, 'mode': ACUnit.MODE_HEAT},
]

if __name__ == "__main__":
    run_testcases(test, check_correctness, testcases, task_name='Task 2.1: ACUnit.get_temperature_change')
